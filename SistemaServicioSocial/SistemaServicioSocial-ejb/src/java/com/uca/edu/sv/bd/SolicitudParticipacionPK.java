 ...
 */
@Embeddable
public class SolicitudParticipacionPK implements Serializable {
    ...
    public SolicitudParticipacionPK() {
    }

    public SolicitudParticipacionPK(int codInstitucion, int corrProyecto, String carne) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SolicitudParticipacionPK)) {
            return false;
        }
        SolicitudParticipacionPK other = (SolicitudParticipacionPK) object;
    ...
    public String toString() {
        return "com.uca.edu.sv.bd.SolicitudParticipacionPK[ codInstitucion=" + codInstitucion + ", corrProyecto=" + corrProyecto + ", carne=" + carne + " ]";
    }
